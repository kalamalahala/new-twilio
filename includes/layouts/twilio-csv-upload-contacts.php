...
// $msid = TwilioCSV::option('twilio_messaging_service_sid');
    ...
    <div class="content-wrap">
        <nav>
            <div class="nav nav-tabs" id="uploads-tab" role="tablist">
                ...
                <!-- Use Bootstrap 4 form-group rows and columns -->
                <div class="container-fluid">
                    ...
                    <form action="" method="post" id="twiliocsv_upload_form">
                        ...
                        <div class="form-group row upload-summary-card d-none">
                            <div class="col-sm-10">
                                <div class="card">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-10">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" id="twilio-csv-column-selector-first-name" name="twilio-csv-column-selector-first-name">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" id="twilio-csv-column-selector-last-name" name="twilio-csv-column-selector-last-name">
                                                <option value="0"><?php echo __('Select Column', 'text-domain'); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" id="twilio-csv-column-selector-email" name="twilio-csv-column-selector-email">
                                                <option value="0"><?php echo __('Select Column', 'text-domain'); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" id="twilio-csv-column-selector-phone-number" name="twilio-csv-column-selector-phone">
                                                <option value="0"><?php echo __('Select Column', 'text-domain'); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" id="twilio-csv-column-selector-city" name="twilio-csv-column-selector-city">
                                                <option value="0"><?php echo __('Select Column', 'text-domain'); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" id="twilio-csv-column-selector-state" name="twilio-csv-column-selector-state">
                                                <option value="0"><?php echo __('Select Column', 'text-domain'); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" id="twilio-csv-column-selector-source" name="twilio-csv-column-selector-source">
                                                <option value="0"><?php echo __('Select Column', 'text-domain'); ?></option>
                                            </select>
                                        </div>
                                    </div>
